import { HypersyncClient, presetQueryBlocksAndTransactionHashes } from "@envio-dev/hypersync-client";
...
async function main() {
  ...
  let query = presetQueryBlocksAndTransactionHashes(17_000_000, 17_000_050);
  ...
  console.log(`Query returned ${res.data.blocks.length} blocks and ${res.data.transactions.length} transaction hashes`)
}
